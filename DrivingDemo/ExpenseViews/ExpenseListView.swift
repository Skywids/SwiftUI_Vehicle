...
fileprivate extension ExpenseListView {
    var titleView: some View {
        HStack {
            ...
            Spacer()
            NavigationLink("Add", destination: AddExpenseView(vehicleId: vehicleId, realm: realm))
        }
    }
    ...
    func getExpenses() {
        let data = realm.objects(Expense.self).filter("vehicleId = %@", vehicleId)
